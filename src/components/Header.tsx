      ...
      <div className="container mx-auto px-4 py-4 xl:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-2 lg:space-x-3 xl:space-x-4" aria-label="Navigation principale">
            ...
            <Link to={lp("/projets")} className="nav-link text-sm lg:text-base text-muted-foreground">{t('nav.projects')}</Link>
            <Link to={lp("/blog")} className="nav-link text-sm lg:text-base text-muted-foreground">{t('nav.blog')}</Link>
        ...
        >
          ...
          >
            <nav className="flex flex-col p-4 space-y-1">
              ...
              <Link to={lp("/projets")} className="py-2.5 px-2 rounded-md nav-link text-muted-foreground hover:bg-primary/10" onClick={closeMenu}>{t('nav.projects')}</Link>
              <Link to={lp("/blog")} className="py-2.5 px-2 rounded-md nav-link text-muted-foreground hover:bg-primary/10" onClick={closeMenu}>{t('nav.blog')}</Link>
              ...
              <div className="mt-2 rounded-xl border border-border bg-muted/20 p-2">
                ...
                <Link to={lp("/loudness")} className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-primary/10 hover:text-foreground" onClick={closeMenu}>
                  <Gauge className="h-4 w-4 text-primary" aria-hidden="true" />
                  <span>{t('nav.loudness')}</span>
                </Link>
                <Link to="/key-bpm-finder" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-primary/10 hover:text-foreground" onClick={closeMenu}>
                  <KeyRound className="h-4 w-4 text-primary" aria-hidden="true" />
                  <span>{t('nav.keybpm')}</span>
                </Link>
                <Link to="/tap-tempo-metronome" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-primary/10 hover:text-foreground" onClick={closeMenu}>
                  <Drum className="h-4 w-4 text-primary" aria-hidden="true" />
                  <span>{t('nav.tempoTools')}</span>
                </Link>
                <Link to="/chord-progression" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-muted-foreground transition-colors hover:bg-primary/10 hover:text-foreground" onClick={closeMenu}>
