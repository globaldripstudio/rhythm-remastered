          ...
          <div className="bg-card/50 border border-border rounded-xl p-4 sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p><strong className="text-foreground">Inclus dans nos prestations de mixage/mastering :</strong> équilibre, dynamique, espace, automation, cohérence globale, master final.</p>
                <p><strong className="text-foreground">Non inclus (mais possible) :</strong> exports multiples, stems, versions alternatives, gros editing, nettoyage extrême, etc.</p>
